...
#
#
# @when('Click on Medicine button')
# def all_btn(context):
#     context.driver.find_element("xpath", '//div[text()="Medicine"]').click()
#
#
...
#
#
# @then('Medicine mode offers should be displayed and User is able to click on Copy Code button and offer code Pop-Up message is displayed')
