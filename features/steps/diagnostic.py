...
#
#
# @when('Click on Diagnostic button')
# def all_btn(context):
#     context.driver.find_element("xpath", '//div[text()="Diagnostic"]').click()
#
#
# @when('Click on Copy Code button')
# def copy_btn(context):
#     try:
#         context.driver.find_element("xpath", '//div[@class="OffersCard_container__2g9dg"][1]//span[text()="Copy Code"]').click()
#
#     except:
#         context.driver.find_element("xpath", '//div[@class="OffersCard_container__2g9dg"][1]//span[text()="Continue"]').click()
#
#
...
#
#
# @then('Diagnostic mode offers should be displayed and User is able to click on Copy Code button and offer code Pop-Up message is displayed')
